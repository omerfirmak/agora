...
public extern (C++) class Nominator : SCPDriver
{
    ...
    private SCPQuorumSetPtr[PublicKey] quorum_set;
...
extern(D):
    ...
    ***************************************************************************/
        ...
        @safe nothrow
    {
        ...
        foreach (qpair; quorums.byKeyValue)  // opApply2 is not nothrow..
        {
            ...
            this.quorum_set[qpair.key] = shared_set;
    ...
    ***************************************************************************/
    ...
    {
        if (auto quorum = PublicKey(node_id[]) in this.quorum_set)
            return *quorum;
